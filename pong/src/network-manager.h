...
#define USE_WIFI_AP
    ...
    // Master
    //const uint8_t L_MAC_1[] = {0x78, 0x21, 0x84, 0xDD, 0xF2, 0x84};
    const uint8_t L_MAC_1[] = {0x7E, 0xDF, 0xA1, 0xE1, 0xBE, 0x60}; //S3_BOX HONZA 7E:DF:A1:E1:BE:60
    // Slave
    //const uint8_t L_MAC_2[] = {0x78, 0x21, 0x84, 0xDE, 0x08, 0x58};
    const uint8_t L_MAC_2[] = {0x7E, 0xDF, 0xA1, 0xE8, 0x12, 0x58}; //S3_BOX VOJTA 7c:df:a1:e8:12:58
#endif
